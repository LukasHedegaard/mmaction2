...
def generate_rawframes_filelist():
    ...
    val_dir_list = [osp.join(val_rawframe_dir, x) for x in os.listdir(val_rawframe_dir)]
    ...
    train_lines = [
        k + " " + str(training[k][0]) + " " + str(training[k][1]) for k in training
    ]
    val_lines = [
